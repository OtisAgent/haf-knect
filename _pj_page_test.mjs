/* Drive the real page: paste a job email into the tile, read the review list,
...
await pg.goto('http://127.0.0.1:8791/', { waitUntil: 'domcontentloaded' });
...
await pg2.goto('http://127.0.0.1:8791/', { waitUntil: 'domcontentloaded' });
...
await pg3.goto('http://127.0.0.1:8791/', { waitUntil: 'domcontentloaded' });

...
head('4. The page is wired into the app');
{
  ...
  /* Nothing above a Luton, ever. "Curtain" is the one word that needs a second
     ...
     TRAILER is not. So the trailer is banned by name, the word is allowed, and
     every remaining mention has to sit inside a Luton. */
  ok('no vehicle beyond a Luton is anywhere on the page',
     !/\b(artic|flatbed|7\.5t|tractor unit|rigid|hgv|curtain[- ]?siders?|curtain[- ]?sided|curtain[- ]?side trailer|curtain trailer)\b/i.test(html));
